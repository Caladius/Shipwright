...
namespace SohGui {
    ...
    std::shared_ptr<PickThreeWindow> mPickThreeWindow;
    ...
    void SetupGuiElements() {
        ...
        mPickThreeWindow = std::make_shared<PickThreeWindow>(CVAR_WINDOW("PickThree"), "Pick Three Game Mode");
        gui->AddGuiWindow(mPickThreeWindow);
    }
